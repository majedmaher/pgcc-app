<div class="mt-100 w-100">
    <div class="card p-20">
        ...
        <div class="card m-10 p-50-100 md-p-20 shadow"> 
            ...
            <form class="w-100 d-flex flex-column gap-50" method="POST" wire:submit.prevent='updateService'>
                <div class="d-grid grid-template-2 sm-grid-template-1 grid-gap-20">
                    <div class="grid-column-full">
                        <h4>{{__('dashboard.update item', ['name'=> __('dashboard.service section')])}}</h4>
                    </div>
                    <div class="form-group">
                        <label  @error('title_ar') class="error" @enderror for="title-arabic">{{__('dashboard.title')}} ({{__('dashboard.arabic')}})</label>
                        <input type="text" name="title-arabic" @error('title_ar') class="is-invalid" @enderror wire:model.defer='service_title_ar' id="title-arabic">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title-english" @error('title_en') class="is-invalid" @enderror wire:model.defer='service_title_en' id="title-english">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="description-arabic" @error('description_ar') class="is-invalid" @enderror wire:model.defer='service_description_ar' id="description-arabic">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="description-english" @error('description_en') class="is-invalid" @enderror wire:model.defer='service_description_en' id="description-english">
            ...
            <div class="save mt-50">
                <button class="mt-50" wire:click='addBtn'>{{__('dashboard.add item', ['name' => __('dashboard.service')])}}</button>
            </div>
            @endif
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <button wire:click='deleteItem({{$service->id}})' wire:confirm='{{__('dashboard.confirmation message')}}' class="btn btn-danger">Delete</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
